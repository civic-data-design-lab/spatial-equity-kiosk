...
export default function Sidebar() {
    ...
    return (
        <div className="d-flex flex-row sidebar h-100">
            ...
            <div className={`${whichOnTop === 2 ? "" : "d-none"} col-3 position-absolute d-flex flex-column h-100`}
                 id={"issues-column"}>
                <div
                    ...
                    <h5 className={`${selectedIssue ? "invis" : "vis"}`}>Text explanation about “health”. Felis donec et
                        odio pellentesque.
                    ...
                    <div>
                        ...
                        <div className={"col"}>
                            <div className={"row issues-arrow-row"}>
                                <div className={"col-2 issues-arrow health"}><FontAwesomeIcon icon={faArrowRight}/>
                                </div>
                                <div className={"col-10 no-padding"}><p className={"mb-2"}>Issue #1</p></div>
                            </div>
                            <div className={"row issues-arrow-row"}>
                                <div className={"col-2 issues-arrow health"}><FontAwesomeIcon icon={faArrowRight}/>
                                </div>
                                <div className={"col-10 no-padding"}><p className={"mb-2"}>Issue #2</p></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <h5 className={`${selectedIssue ? "invis" : "vis"}`}>Text explanation about “environment”. Turpis
                ...
                <div className={`${selectedIssue === 2 ? 'vis' : 'invis'} accordion-content flex-grow-1`}>
                    <h5 className="collapse-text mb-3">Text explanation about “health”. Felis donec et odio pellentesque.
                        Elit at imperdiet dui accumsan sit amet. Diam donec adipiscing tristique risus nec feugiat in.
                        Vel turpis nunc eget lorem dolor sed viverra. </h5>
                    <div>
                        <h5>Select an issue to explore</h5>
                        <div className={"col"}>
                            <div className={"row issues-arrow-row"}>
                                <div className={"col-2 issues-arrow environment"}><FontAwesomeIcon icon={faArrowRight}/>
                                </div>
                ...
                <div
                    ...
                    <h5 className={`${selectedIssue ? "invis" : "vis"}`}>Text explanation about “infrastructure”
            ...
            <div className={`${whichOnTop === 3 ? "" : "d-none"} col-3 position-absolute d-flex flex-column h-100`}
                 id={"community-column"}>
