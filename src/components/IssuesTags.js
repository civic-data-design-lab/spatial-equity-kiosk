        ...
        <div className={"more-issues-container"}>
            ...
            <div className={"issue-tags-container"}>
            {
                issues.all_issues_id
                    ...
                    .map((id) => {
                    return (
                        <div className={`${moreIssues.includes(id) ? "active-tag" : "inactive-tag"} issues-tag col-gap`}
                        ...
                        >
                            ...
                            {moreIssues.includes(id) ? <FontAwesomeIcon icon={faMinus}/> : <FontAwesomeIcon icon={faPlus}/>}
                        </div>
                    )
                })
