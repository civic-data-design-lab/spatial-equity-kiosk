...
export default function IssuesCard({issues, selectedSpecificIssue, setSelectedSpecificIssue}) {
    ...
    return(
        <div className={"issues-card-container"}
            onClick={()=>{
                setSelectedSpecificIssue(selectedSpecificIssue)
            }}
        >
            <div className={"issues-card-header"}>
                <div className={"issues-card-title-container col-gap"}>
                    <p className={"m-0"}>{getIssueName()}</p>
                    <p className={"m-0 small-text"}>{issues.specific_issues_data[selectedSpecificIssue].specific_issue_units}</p>
                </div>
                <div className={"issues-card-button-container col-gap"}>
                    ...
                    >
                        ...
                        <div className={`${showInfo ? "" : "d-none"} position-absolute info-tooltip`}>
                            <p className={"m-0"}>{issues.specific_issues_data[selectedSpecificIssue].specific_issue_source}</p>
                        </div>
                    </div>
            ...
            <div className={"issues-card-body"}>
                ...
                <div>
                    <p className={"m-0 small-text"}>{issues.specific_issues_data[selectedSpecificIssue].specific_issue_sentence}</p>
                </div>
            </div>
