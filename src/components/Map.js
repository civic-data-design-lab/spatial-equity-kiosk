                      ...
                      ? `${
                          ...
                          typeof selectedSpecificIssue == 'number'
                            ? issues.specific_issues_data[selectedSpecificIssue]
                              ...
                              ? `<strong>${issues.specific_issues_data[selectedSpecificIssue].issue_units_symbol} ${issues.specific_issues_data[selectedSpecificIssue].issue_units_shorthand}</strong>`
                              : `<strong>${issues.specific_issues_data[selectedSpecificIssue].issue_units_symbol} ${issues.specific_issues_data[selectedSpecificIssue].specific_issue_units}</strong>`
                            : ''
                        }`
                      : ''
                  }.`
