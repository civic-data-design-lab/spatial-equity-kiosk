  ...
  return (
    ...
    <div id={'about-container'}>
      ...
      <div className={'scroll-menu-box h-100 flex-column border-box'}>
        <a 
          href={'#content-1'} 
          className={`about-link scroll-menu-chapters d-flex flex-column justify-content-between no-left-border no-right-border ${currentStepIndex == 1 ? 'nav-chapters-active' : ""}`}>
        ...
        <a 
          href={'#content-2'} 
          className={`about-link scroll-menu-chapters d-flex flex-column justify-content-between no-left-border no-right-border ${currentStepIndex == 2 ? 'nav-chapters-active' : ""}`}>
        ...
        <a 
          href={'#content-3'} 
          className={`about-link scroll-menu-chapters d-flex flex-column justify-content-between no-left-border no-right-border ${currentStepIndex == 3 ? 'nav-chapters-active' : ""}`}>
        ...
        <a 
          href={'#content-4'} 
          className={`about-link scroll-menu-chapters d-flex flex-column justify-content-between no-left-border no-right-border ${currentStepIndex == 4 ? 'nav-chapters-active' : ""}`}>
        ...
        <a 
          href={'#content-5'} 
          className={`about-link scroll-menu-chapters d-flex flex-column justify-content-between no-left-border no-right-border ${currentStepIndex == 5 ? 'nav-chapters-active' : ""}`}>
        ...
        <a 
          href={'#content-6'} 
          className={`about-link scroll-menu-chapters d-flex flex-column justify-content-between no-left-border no-right-border ${currentStepIndex == 6 ? 'nav-chapters-active' : ""}`}>
        ...
        <a 
          href={'#content-7'} 
          className={`about-link scroll-menu-chapters d-flex flex-column justify-content-between no-left-border no-right-border ${currentStepIndex == 7 ? 'nav-chapters-active' : ""}`}>
        ...
        <a 
          href={'#content-8'} 
          className={`about-link scroll-menu-chapters d-flex flex-column justify-content-between no-left-border no-right-border  ${currentStepIndex == 8 ? 'nav-chapters-active' : ""}`}>
        ...
        <a 
          href={'#content-9'} 
          className={`about-link scroll-menu-chapters d-flex flex-column justify-content-between no-left-border no-right-border ${currentStepIndex == 9 ? 'nav-chapters-active' : ""}`}>
      ...
      <div className={'scroll-title-box issues-chapters-active collapse-issue issues-chapters top-border transition-height border-box'}>
        <h6 className={'mb-0'}>
            {currentStepIndex < 4
