        ...
        <div className={"h-100 overflow-auto"}>
            <div className={"thicker-padding d-flex flex-column w-100"}>
                ...
                <div className={"w-100 d-flex flex-row"}>
                    ...
                    <div className={"col-8 standard-padding"}>
                        <p>
                            ...
                            aliquip ex ea commodo consequat. Ornare aenean euismod elementum nisi quis eleifend quam.
                ...
                <div className={"w-100 d-flex flex-row"}>
                    ...
                    <div className={"col-8 standard-padding d-flex flex-column row-gap"}>
                                    ...
                                    return (
                                        <>
                                            ...
                                            <div
                                                ...
                                                <FontAwesomeIcon icon={faCaretRight} className={"opacity-0 pe-none"}/>
                    ...
                    <div className={"col-8 standard-padding d-flex flex-column row-gap"}>
                        ...
                        <div>
                            ...
                            <p>Transportation Alternatives’ mission is to reclaim New York City’s streets from the
                                ...
                                biking and public transit for all New Yorkers. Transportation Alternatives’ mission is
                        ...
                        <div>
                            ...
                            <p> The MIT Civic Data Design Lab works with data to understand it for public good. We seek
                                to develop alternative practices which
                                can make the work we do with data and images richer, smarter, more relevant, and more
                                ...
                                and collection tools that allow us to highlight urban phenomena. Our methods borrow from
