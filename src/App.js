...
const expandAssist = () => {
    ...
    div.style.transition = 'height 0.5s 0.2s, width 0.5s 0.2s, background-color 1s, color 1s';
    div.style.transform = `translate(${offsetLeft}px, ${offsetTop}px)`;
    setTimeout(() => {
        div.style.transition = 'transform 0.5s, height 0.5s 0.2s, width 0.5s 0.2s, background-color 1s, color 1s';
        div.style.transform = `translate(0px, 0px)`;
    }, 50);
                    ...
                    <div
                        ...
                        onTouchStart={(e) => {
                            if (!openAssist) {
                                ...
                                setOffset({x: div.offsetLeft - touch.clientX, y: div.offsetTop - touch.clientY});
                            }
                        }}
