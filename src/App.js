        ...
        <Protect isEnabled={siteProtection} sha512={sha512}>
            {useWindowSize().width >= 576 ? (
              ...
              ></span>
                    ...
                    >
                        <div className={"mobile-landing-video"}
                             onClick={(e)=>{
                                 e.stopPropagation()
                                ...
                                <div className={"d-flex flex-column justify-content-between"}>
                                    ...
                                    <p style={{
                                       ...
                                       transition: "font-size 0.5s, opacity 0.5s"
                                        ...
                                        distributed, and accessed. Browse citywide data or search community
                                        profiles to learn how decisions about the use of public space lead
                                        to unequal outcomes and what you can do about it.
                                    </p>
                                </div>
                            </div>
                            <iframe
                        ...
                        >
                            <div className={"mobile-landing-menu-item"}
                                 style={{
